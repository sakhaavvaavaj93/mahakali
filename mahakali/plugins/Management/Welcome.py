...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("mahakali/assets/dil.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((1157, 1158))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('mahakali/assets/font.ttf', size=110)
    welcome_font = ImageFont.truetype('mahakali/assets/font.ttf', size=60)
